...
func GetChatModel(ctx context.Context, conf *config.Config) (model.BaseChatModel, error) {
	if chatModel != nil {
...
func GetRewriteModel(ctx context.Context, cfg *qwen.ChatModelConfig) (model.BaseChatModel, error) {
	...
	if cfg == nil {
		cfg = &qwen.ChatModelConfig{
			APIKey:  "sk-yzwvyxeuhxdroxmjpzbotkqndwqclwtxbauggjzeuxtjdraw",
...
func GetImageModel(ctx context.Context, cfg *openai.ChatModelConfig) (model.BaseChatModel, error) {
	if qaModel != nil {
		return qaModel, nil
	}
	if cfg == nil {
